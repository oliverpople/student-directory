...
def confirm_save_students
  ...
  # check if the file exists & if it does, ask if they want to overwrite or append
    puts "#{filename} doesn't currently exist. Creating new file called #{filename}."
    #CSV.open(filename, accessor_method)
  end
  # if it doesn't, then save the array (it'll create the file)
  # in summary, this proc determines the name of the file and the accessor method (w / a)
  # filename, accessor_method
